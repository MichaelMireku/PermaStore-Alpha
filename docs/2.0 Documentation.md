# PermastoreIt 2.0 Documentation
...
- **Simple HTTP API**: Easy to use RESTful API

## Architecture Overview

PermastoreIt 2.0 follows a modular architecture with six main components:
